...
status is `15 / 18` after compact dimension-binding, quantifier-threshold,
nested-conditional, scoped-exception, and temporal role-binding passes. Its
workflow is documented in `docs/exp25_challenge.md`; EXP25 is a development
probe, not a benchmark claim. The broader development direction is recorded in
`docs/roadmap.md`.
